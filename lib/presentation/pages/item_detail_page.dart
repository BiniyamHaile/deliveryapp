...
import 'package:deliveryapp/presentation/styles/font/appButton.dart';
import 'package:deliveryapp/presentation/styles/text.dart';
import 'package:deliveryapp/presentation/views/widgets/favourite_icon.dart';
import 'package:deliveryapp/presentation/views/widgets/item_counter.dart';
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    getProductDataRowWidget("የእቃው ዝርዝር"),
                    const Divider(thickness: 1),
                    getProductDataRowWidget("የተገነባበት",
